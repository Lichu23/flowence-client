...
export function EmptyState({ 
  ...
  return (
    <div className={`text-center py-8 sm:py-12 ${className}`}>
      ...
      {description && (
        <p className="text-sm sm:text-base text-muted mb-4 px-4 max-w-md mx-auto">
          {description}
        </p>
      )}
      {action && (
...
export const EmptyStateIcons = {
  NoData: (
    <svg className="w-12 h-12 sm:w-16 sm:h-16 text-subtle mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
