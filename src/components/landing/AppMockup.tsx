    ...
    <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative">
        ...
        <div className="relative mx-auto w-full max-w-[280px] sm:max-w-[320px] bg-gradient-to-br from-purple-500 via-fuchsia-500 to-purple-500 rounded-[2.5rem] p-[3px] shadow-2xl shadow-purple-500/50">
          <div className="bg-black rounded-[2.4rem] p-4 sm:p-6">
            <div className="flex items-center justify-between mb-6 text-xs text-foreground-muted">
            ...
            <div className="text-left mb-4">
              <h3 className="font-semibold text-foreground mb-1 text-sm sm:text-base">Leche Entera 1L</h3>
              <p className="text-xs text-foreground-subtle mb-2">SKU: 7501234567890</p>
              <div className="flex items-end gap-2">
                <span className="text-xl sm:text-2xl font-bold text-purple-400">$24.90</span>
                <span className="text-xs sm:text-sm text-success mb-1">En stock: 156</span>
              </div>
            </div>

            <button className="w-full py-3 btn-primary text-sm shadow-purple-lg">
              Agregar al carrito
            </button>
          </div>
        </div>
            ...
            <div className="bg-black rounded-2xl p-5">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-foreground">Ventas Hoy</span>
                </div>
                <span className="text-xs text-success flex items-center gap-1 font-medium">+23%</span>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/50 to-fuchsia-500/50 rounded-2xl p-[2px] shadow-2xl shadow-purple-500/30">
            <div className="bg-black rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-medium text-foreground">Inventario</span>
              </div>
              <div className="text-3xl font-bold mb-2 text-foreground">1,247</div>
              <p className="text-xs text-foreground-muted mb-3">Total productos</p>
              <div className="flex items-center gap-1 text-xs bg-warning/10 border border-warning/20 rounded-lg px-2 py-1.5">
                <div className="w-2 h-2 rounded-full bg-warning"></div>
                <span className="text-warning font-medium">23 por reabastecer</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:block absolute -right-4 bottom-4 w-44">
          <div className="bg-gradient-to-br from-purple-500/50 to-fuchsia-500/50 rounded-2xl p-[2px] shadow-2xl shadow-purple-500/30">
            <div className="bg-black rounded-2xl p-5">
              ...
              <p className="text-center text-xs text-foreground-muted mt-3">Meta</p>
            </div>
          </div>
        </div>
      </div>
