  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none bg-card border border-crisp rounded-lg pl-10 pr-10 py-2 text-foreground font-medium focus-contrast cursor-pointer hover:border-crisp-light hover:bg-glass-5 transition-all"
      >
        {stores.map((store) => (
