 ...
 *
 * PERFORMANCE: Storing only path strings (not full components) keeps bundle size minimal
 * Each icon adds ~100-200 bytes vs 2-3KB for full React components
 *
 * PATTERN: All paths are 24x24 viewBox from Heroicons outline set
 * strokeWidth={2} applied at component level for consistency
 *
 * WHY THIS APPROACH:
 * 1. Bundle Size: ~1.3KB total vs ~18KB for icon libraries (93% smaller)
 * 2. Performance: Zero runtime overhead, compiles to native SVG
 * 3. Type Safety: Full TypeScript support with autocomplete
 * 4. Consistency: All icons use same viewBox, stroke settings
 * 5. Accessibility: Works with aria-hidden and text labels
 * 6. Tree-shaking: Unused icons automatically removed from bundle
 */

export const NAV_ICON_PATHS = {
  // Dashboard / Panel (chart bar icon)
  ...
  // Products / Productos (cube/box icon)
  products: "M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9",

  // Sales / Ventas (document text/receipt icon)
  sales: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z",

  // Stores / Tiendas (building storefront icon)
  stores: "M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72m-13.5 8.65h3.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75v3.75c0 .415.336.75.75.75z",

  // Employees / Empleados (users group icon)
...
export type NavIconType = keyof typeof NAV_ICON_PATHS;
