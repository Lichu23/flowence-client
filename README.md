...
> Modern, multi-tenant Point of Sale (POS) system with inventory management, barcode scanning, and multi-store support.
...
**Flowence Client** is a production-ready Next.js 15 frontend for a comprehensive multi-tenant Point of Sale (POS) system. It provides store owners and employees with powerful tools to manage inventory, process sales, track returns, and handle multi-store operations seamlessly.

### Key Capabilities

- 🏪 **Multi-Store Management**: Owners can create and manage multiple stores from a single account
- 💳 **Point of Sale**: Fast, responsive POS terminal with cash and card payment support
- 📦 **Inventory Management**: Dual-stock system (sales floor + warehouse) with low-stock alerts
- 📊 **Dashboard Analytics**: Real-time sales statistics, revenue tracking, and defective product monitoring
- 👥 **Employee Management**: Invitation system with role-based access control
- 📱 **Barcode Scanning**: Integrated Scandit barcode scanner with manual camera toggle
- 💰 **Multi-Currency**: Currency conversion with real-time exchange rates
- 🧾 **Receipts & Returns**: PDF receipt generation and comprehensive return management
...
- Store-specific settings (currency, timezone, date/time formats)
- Store selector in navigation bar
- Per-store statistics and analytics
- Employee invitation system

### 💼 Point of Sale (POS)
- Real-time product search with autocomplete
- Barcode scanning with **manual camera toggle** (new!)
- Shopping cart with quantity adjustments
- Cash and card payment processing
- Change calculation for cash payments
- Manual card payment confirmation
- Receipt generation and download
- Dual-stock system (sales floor + warehouse)
...
- Warehouse restocking operations
- Product filtering and search
- Active/inactive product status
- Barcode support (8-14 digits)

### 📊 Dashboard
- Total revenue and sales statistics
- Today's revenue with comparison to previous period
- Products sold today
- Defective products tracking
- Multi-store global summary (for owners)
...
- Per-store employee management
- Employee statistics

### 🌍 Internationalization
- Multi-currency support (USD, EUR, ARS, etc.)
- Real-time currency conversion
- Customizable date/time formats
- Timezone support
- Locale-specific number formatting
- Special handling for Argentine Pesos (ARS)
...
### Key Libraries
- **Barcode Scanning**: [Scandit Web SDK 8.0.0](https://www.scandit.com/)
- **Payments**: [Stripe React 5.2.0](https://stripe.com/)
- **Icons**: [Lucide React 0.545.0](https://lucide.dev/)
- **QR Codes**: [qrcode 1.5.4](https://github.com/soldair/node-qrcode)

### Testing
- **Unit Tests**: [Jest 30.2.0](https://jestjs.io/) + [React Testing Library 16.3.0](https://testing-library.com/)
- **E2E Tests**: [Playwright 1.56.1](https://playwright.dev/)
...
This frontend requires the Flowence backend API to be running. The backend typically runs on `http://localhost:3002`.
